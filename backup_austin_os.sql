...
--
-- Host: localhost    Database: austin_os
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'e76ff97c-cc69-11f0-a9e0-fa3c3b728d6d:1-11853';
...
--
-- Table structure for table `automations_automationlog`
--
...
--
-- Dumping data for table `automations_automationlog`
--
...
--
-- Table structure for table `automations_automationrule`
--
...
--
-- Dumping data for table `automations_automationrule`
--
...
--
-- Table structure for table `billing_billingconfig`
--
...
--
-- Dumping data for table `billing_billingconfig`
--
...
--
-- Table structure for table `billing_invoiceitem`
--
...
--
-- Dumping data for table `billing_invoiceitem`
--
...
--
-- Table structure for table `billing_propertybillingconfig`
--
...
--
-- Dumping data for table `billing_propertybillingconfig`
--
...
--
-- Table structure for table `common_statetransitionlog`
--
...
--
-- Dumping data for table `common_statetransitionlog`
--
...
--
-- Table structure for table `guests_guest`
--
...
--
-- Dumping data for table `guests_guest`
--
...
--
-- Table structure for table `guests_guestnote`
--
...
--
-- Dumping data for table `guests_guestnote`
--
...
--
-- Table structure for table `organizations_bankaccount`
--
...
--
-- Dumping data for table `organizations_bankaccount`
--
...
--
-- Table structure for table `organizations_property`
--
...
--
-- Dumping data for table `organizations_property`
--
...
--
-- Table structure for table `organizations_propertyphoto`
--
...
--
-- Dumping data for table `organizations_propertyphoto`
--
...
--
-- Table structure for table `pricing_dayofweekpricing`
--
...
--
-- Dumping data for table `pricing_dayofweekpricing`
--
...
--
-- Table structure for table `pricing_rateplan`
--
...
--
-- Dumping data for table `pricing_rateplan`
--
...
--
-- Table structure for table `pricing_season`
--
...
--
-- Dumping data for table `pricing_season`
--
...
--
-- Table structure for table `reservations_payment`
--
...
--
-- Dumping data for table `reservations_payment`
--
...
--
-- Table structure for table `rooms_bedconfiguration`
--
...
--
-- Dumping data for table `rooms_bedconfiguration`
--
...
--
-- Table structure for table `rooms_bedconfigurationdetail`
--
...
--
-- Dumping data for table `rooms_bedconfigurationdetail`
--
...
--
-- Table structure for table `rooms_room_room_types`
--
...
--
-- Dumping data for table `rooms_room_room_types`
--
...
--
-- Table structure for table `rooms_roomtypephoto`
--
...
--
-- Dumping data for table `rooms_roomtypephoto`
--
...
--
-- Table structure for table `users_user_properties`
--
...
--
-- Dumping data for table `users_user_properties`
--
...
-- Dump completed on 2026-02-12  9:30:54
