  ...
  if (template === "premium") {
    return (
      <section className="relative overflow-hidden">
        {/* Diamant-style 45deg gradient */}
        <div
          className="absolute inset-0"
          style={{
            background: "linear-gradient(45deg, #272535 0%, #c4a676 100%)",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 sm:py-36">
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-white/70 text-xs sm:text-sm uppercase tracking-[0.25em] font-sans font-medium mb-6">
              ...
              <p className="text-white/60 font-sans max-w-lg mx-auto mb-12 leading-relaxed text-base">
              ...
              <Link
                href="/disponibilidad"
                className="inline-flex items-center justify-center bg-white text-primary-900 hover:bg-white/90 rounded-full px-10 py-4 font-sans text-sm font-medium uppercase tracking-[0.15em] transition-all duration-500"
              >
